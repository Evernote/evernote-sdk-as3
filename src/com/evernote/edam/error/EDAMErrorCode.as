...
import flash.utils.Dictionary;
  public class EDAMErrorCode   {
    ...
    public static const UNSUPPORTED_OPERATION:int = 17;

    public static const VALID_VALUES:Set = new Set(UNKNOWN, BAD_DATA_FORMAT, PERMISSION_DENIED, INTERNAL_ERROR, DATA_REQUIRED, LIMIT_REACHED, QUOTA_REACHED, INVALID_AUTH, AUTH_EXPIRED, DATA_CONFLICT, ENML_VALIDATION, SHARD_UNAVAILABLE, LEN_TOO_SHORT, LEN_TOO_LONG, TOO_FEW, TOO_MANY, UNSUPPORTED_OPERATION);
    public static const VALUES_TO_NAMES:Dictionary = new Dictionary();
    {
      ...
      VALUES_TO_NAMES[UNSUPPORTED_OPERATION] = "UNSUPPORTED_OPERATION";
