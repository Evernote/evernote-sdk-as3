...
import com.evernote.edam.type.PremiumInfo;
  ...
  public class UserStoreProcessor implements TProcessor {
    public function UserStoreProcessor(iface:UserStore)
    {
      ...
      PROCESS_MAP["authenticateLongSession"] = authenticateLongSession();
      PROCESS_MAP["authenticateToBusiness"] = authenticateToBusiness();
    ...
    private function authenticateLongSession():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          trace("Internal error processing authenticateLongSession", th);
          var x:TApplicationError = new TApplicationError(TApplicationError.INTERNAL_ERROR, "Internal error processing authenticateLongSession");
    ...
    private function authenticateToBusiness():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          trace("Internal error processing authenticateToBusiness", th);
          var x:TApplicationError = new TApplicationError(TApplicationError.INTERNAL_ERROR, "Internal error processing authenticateToBusiness");
